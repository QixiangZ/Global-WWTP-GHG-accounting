...
PARAM_KEYS = ['max_depth', 'num_leaves', 'n_estimators',
              'min_child_samples', 'learning_rate']
...
def build_model(params, seed):
    ...
    return LGBMClassifier(
        ...
        reg_alpha=REG_ALPHA, reg_lambda=LGBM_FIXED_LAMBDA,
        n_jobs=N_JOBS_MODEL, random_state=seed, verbose=-1,
    )
